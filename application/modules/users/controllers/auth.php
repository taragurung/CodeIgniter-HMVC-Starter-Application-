...
class Auth extends Admin_Controller
{
    ...
    function _render_page($view, $data = null, $render = false)
    {
        ...
        if ($this->data['content'] == 'auth/login' OR $this->data['content'] == 'auth/forgot_password') {
            ...
            $this->data['theme_path'] = 'theme/default/home';
            $this->data['theme_header'] = 'theme/default/elements/header';
            $this->data['theme_footer'] = 'theme/default/elements/footer';
            $this->data['theme_right_side_bar'] = 'theme/default/partials/right-sidebar';
            $this->data['theme_top_nav'] = 'theme/default/partials/nav';
        }
        $view_html = $this->load->view($this->data['theme_path'], $this->data, $render);
        if (!$render)
            return $view_html;
    }
